    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incidencia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lotes_incidencia', to='erp.incidencia', verbose_name='incidencia')),
                ('lote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incidencias_lote', to='inventario.loteinventario', verbose_name='Lote de Inventario')),
