...
class LoteInventarioSerializer(serializers.Serializer):
    ...
    cantidad = serializers.DecimalField(max_digits=10, decimal_places=3, read_only=True)
...
class ProductoInventarioSerializer(serializers.Serializer):
    ...
    cantidad_total = serializers.DecimalField(max_digits=10, decimal_places=3, read_only=True)
...
class DetalleInventarioPorProductoSerializer(serializers.Serializer):
    ...
    precio_mayoreo_calculado = serializers.DecimalField(max_digits=10, decimal_places=2, read_only=True)
    precio_publico_calculado = serializers.DecimalField(max_digits=10, decimal_places=2, read_only=True)
    ...
    cantidad_total_global = serializers.DecimalField(max_digits=10, decimal_places=3, read_only=True)
...
class DetalleInventarioRackSerializer(serializers.Serializer):
    ...
    total_productos = serializers.IntegerField(read_only=True)
    total_lotes = serializers.IntegerField(read_only=True)
    cantidad_total = serializers.DecimalField(max_digits=12, decimal_places=3, read_only=True)
